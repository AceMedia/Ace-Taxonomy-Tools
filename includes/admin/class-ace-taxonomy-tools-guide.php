...
<p><strong>Edit inline.</strong> Inputs follow the field: colour picker, media picker, select, date, URL. The legend above the table lists the keys: <kbd>Enter</kbd> saves and drops to the same field on the next row, <kbd>Shift+Enter</kbd> goes up, <kbd>Ctrl+Enter</kbd> saves in place, <kbd>↑</kbd>/<kbd>↓</kbd> move between rows without saving, <kbd>Ctrl+↑</kbd>/<kbd>↓</kbd> jump to the first or last row, <kbd>Alt+←</kbd>/<kbd>→</kbd> change page and <kbd>Esc</kbd> puts a cell back. The line above the legend always says which term, field, row and page you are on. Click a column header to sort the page. Each row saves by itself the moment you leave a field. The status column tells you what changed; a row that did not change is skipped, so nothing is rewritten needlessly and Ace Revisions only sees real edits.</p>
